...
<div class="content">
        ...
        <div class="transportContainer">
            ...
            <div class="transportControls">
                ...
                <div class="navigation" id="navigation">
                    ...
                    <a href="https://mthw.s3.eu-west-2.amazonaws.com/db/solution.mp3" download><button class="action-btn action-btn-big">
    ...
    <div class="audioPlayer">
        <audio id="audio" preload="none">
            <!-- <source src="https://mthw.s3.eu-west-2.amazonaws.com/db/supafly.ogg" type="https://mthw.s3.eu-west-2.amazonaws.com/db/ogg"> -->
            <source src="https://mthw.s3.eu-west-2.amazonaws.com/db/solution.mp3" type="audio/mpeg">
...
$mixtape = '7% Solution';  // Change this value for each PHP page to reflect the mixtape
