    ...
    <div class="transportContainer">
        ...
        <div class="transportControls">
            ...
            <div class="navigation" id="navigation">
                ...
                <a href="../audio/gf/straight_life.mp3" download><button class="action-btn action-btn-big">
...
<div class="audioPlayer">
    <audio id="audio" preload="none" crossorigin="anonymous">
        <source src="../audio/gf/straight_life.mp3" type="audio/mpeg">
...
<div class="reviewsStrip">
    ...
    <div class="reviewsBox">
        ...
        <?php
        $mixtape = 'Straight Time';  // Change this value for each PHP page to reflect the mixtape
